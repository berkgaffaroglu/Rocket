...
from Rocket import app,db,bcrypt,mail
...
def update_post(post_id):
    ...
    return render_template('create_post.html', legend='Update Post', title="Update The Post" ,form=form)
...
def user_posts(username):
    ...
    return render_template('user_posts.html', title=f"{user.username}'s posts" ,posts=posts, user=user)
